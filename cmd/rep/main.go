...
func main() {
	...
	executorClient, executorMembers, err := executorinit.Initialize(logger, repConfig.ExecutorConfig, repConfig.VContainerClientConfig, gardenHealthcheckRootFS, metronClient, clock)
	if err != nil {
