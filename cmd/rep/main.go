...
func main() {
	...
	executorClient, executorMembers, err := executorinit.Initialize(logger, repConfig.ExecutorConfig, repConfig.VContainerClientConfig, repConfig.CellID, gardenHealthcheckRootFS, metronClient, clock)
	if err != nil {
